    ...
    <div class="app-wrapper">
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl" id="">
                <h1 class="app-page-title">Reporte de Matenimientos</h1>
                <hr class="mb-4">
                                                ...
                                                <div class="app-card-body">
                                                    <form class="settings-form">
                                                        <div class="row justify-content-between">
                                                            ...
                                                            <div class="col-3 mb-3">
                                                                <label for="setting-input-2" class="form-label">Mantenimiento realizado por</label>
                                                            ...
                                                            <table class="table app-table-hover mb-0 text-left">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="cell">Mantenimiento realizado</th>
                                                            ...
                                                            <table class="table app-table-hover mb-0 text-left">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="cell">Fecha</th>
                                                                        <th class="cell">Solicitante</th>
                                                                        <th class="cell">Mantenimiento realizado por</th>
                                                                        <th class="cell">Encargado</th>
                                                                        <th class="cell">Equipo</th>
                                                                    </tr>
                                                                </thead>
