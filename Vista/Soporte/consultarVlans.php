...
<div class="row g-3 mb-4 align-items-center justify-content-between">
        ...
        <div class="page-utilities">
            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                ...
                <div class="col-auto">
                    ...
                    <button type="button" id="limpiarCampos" class="btn app-btn-secondary" data-bs-toggle="modal" data-bs-target="#modalCrearVlan">
                    Agregar VLAN
                    </button>
                </div>
            </div>
 ...
 <!-- Modal Agregar Vlans-->
 <div class="modal fade" id="modalCrearVlan" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                    aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="staticBackdropLabel">Agregar VLAN</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                               <form class="settings-form" id="formVlans">
                                  <div class="modal-body">
                                      <div class="col-12 col-md-12">
                                              <div class="mb-3">
                                                  <label for="formGroupExampleInput" class="form-label">VLAN</label>                                      
                                                  <input type="text" id="vlan" class="form-control" required>                                        
                                              </div>            
                                       </div>
                                  </div>
               ...
               <!-- Modal Editar Vlans-->
               <div class="modal fade" id="modalEditarVlan" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                    aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                               ...
                               <form class="settings-form" id="formEditarVlans">
                                  <div class="modal-body">
                                      <div class="col-12 col-md-12">
                                              <div class="mb-3">
                                                  <input id="id" type="hidden" name="id">
                                                  <label for="formGroupExampleInput" class="form-label">VLAN</label>                                      
                                                  <input type="text" id="vlan2" class="form-control" required>                                        
                                              </div>            
                                       </div>
                                  </div>
                                  <div class="modal-footer">
...
<div class="tab-content" id="orders-table-tab-content">
        ...
        <div class="app-card app-card-orders-table shadow-sm mb-5">
            <div class="app-card-body">
                <div class="table-responsive">
                    <table id="datos_vlans" class="table app-table-hover mb-0 text-left">
                        <thead>
                            <tr>
    ...
    <script type="text/javascript" src="vlansController.js"></script> 
