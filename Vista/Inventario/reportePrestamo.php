...
<body class="app">
     ...
     <div class="app-wrapper">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl" id="">
                <h1 class="app-page-title">Reporte de préstamos</h1>
                <hr class="mb-4">
                        ...
                        <div class="row g-4 settings-section">
                            <div class="col-12 col-md-12">
                                <div class="app-card app-card-settings shadow-sm p-4">
                                    <div class="app-card-body">
                                        <form class="settings-form" id="prestamos">
    ...
    <script>
        ...
        $('#prestamos').submit(function(e) {
            ...
            console.log(fechaF);
            $.ajax({
                url: "obtener_reportePrestamo.php",
                type: "POST",
                datatype: "json",
                data: {
