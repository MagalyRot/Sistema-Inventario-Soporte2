...
function obtener_todos_registros(){
    include("Conexion.php");
    $stmt = $conexion->prepare("SELECT *FROM vista_asignacionestemporales"); 
    $stmt->execute();
    ...
    $query = '';
    $salida = array();   
    $query = "SELECT * from vista_asignacionestemporales ";
    $columns = array('folio','fechaI','fechaE','ubi','persona');
