...
FROM personal as p INNER JOIN detalleasig_per as dp ON dp.id_personal=p.id_per INNER JOIN asignaciones as a ON a.id_asig=dp.id_asig INNER JOIN ubicaciones as u ON a.ubicacion=u.id_ubi and p.tipo_per=1 and a.estado_asig=2 and a.fechaFin BETWEEN '$fechaI' AND '$fechaF' ORDER BY a.fechaFin DESC");
