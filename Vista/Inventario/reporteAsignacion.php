                                                ...
                                                <div class="app-card-body">
                                                    <form class="settings-form">
                                                        <div class="row justify-content-between">
                                                            ...
                                                            <div class="col-3 mb-3">
                                                                <label for="setting-input-2" class="form-label">Asignaciones realizadas por</label>
                                                            ...
                                                            <table class="table app-table-hover mb-0 text-left">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="cell">Asignaciones realizadas</th>
                                                            ...
                                                            <table class="table app-table-hover mb-0 text-left">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="cell">Fecha</th>
                                                                        <th class="cell">Solicitante</th>
                                                                        <th class="cell">Asignaciones realizadas por</th>
                                                                        <th class="cell">Encargado</th>
                                                                        <th class="cell">Equipo</th>
                                                                    </tr>
                                                                </thead>
