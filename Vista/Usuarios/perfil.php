                        ...
                        <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                            <div class="app-card-header p-3 border-bottom-0">
                                <div class="row align-items-center gx-3">
                                    <div class="col-auto">
                                        <div class="app-icon-holder2">
                                            <svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-person"
                            ...
                            <div class="app-card-body px-4 w-100">
                                ...
                                <div class="item border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
                                            ...
                                            <div class="item-data"><?php echo $name ?></div>
                                        </div>
                                        <!--//col-->
                                ...
                                <div class="item border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
                                            ...
                                            <div class="item-data"> <?php echo $app," ",$apm ?></div>
                                        </div>
                                        <!--//col-->
                                        <div class="col text-end">
                                            <!-- <a class="btn-sm app-btn-secondary" href="#"></a>-->
                                ...
                                <div class="item border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
                                            <div class="item-label"><strong>N. Trabajador</strong></div>
                                            <div class="item-data"><?php echo $ntrab ?></div>
                                        </div>
                                        <!--//col-->
                                        <div class="col text-end">
                                            <!-- <a class="btn-sm app-btn-secondary" href="#"></a>-->
								...
								<div class="item border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
                                            <div class="item-label"><strong>Tipo de trabajador</strong></div>
                                            <div class="item-data"><?php echo $tipo ?></div>
                                        </div>
                                        <!--//col-->
                                        <div class="col text-end">
                                            <!-- <a class="btn-sm app-btn-secondary" href="#"></a>-->
                        ...
                        <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                            <div class="app-card-header p-3 border-bottom-0">
                                <div class="row align-items-center gx-3">
                                    <div class="col-auto">
                                        <div class="app-icon-holder2">
                                            <svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-sliders"
                                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
                            ...
                            <div class="app-card-body px-4 w-100">
								<div class="item border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
                                            ...
                                            <div class="item-data"><?php echo $correo?></div>
                                        </div>
                                        <!--//col-->
                                        <div class="col text-end">
                                ...
                                <div class="item border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
                                            <div class="item-label"><strong>Rol</strong></div>
                                            <div class="item-data"><?php echo $rol ?></div>
                                        </div>
                                        <!--//col-->
                                        <div class="col text-end">
                                            <!-- <a class="btn-sm app-btn-secondary" href="#">Change</a>-->
                                ...
                                <div class="item border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
                                            ...
                                            <div class="item-data"><?php if($estado ==1){echo "Activo";}else{echo "Inactivo";}?></div>
                                        </div>
                                        <!--//col-->
                                        <div class="col text-end">
                                            <!-- <a class="btn-sm app-btn-secondary" href="#">Change</a> -->
