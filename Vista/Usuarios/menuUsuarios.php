        ...
        <ul class="app-menu list-unstyled accordion" id="menu-accordion">
            ...
            <li class="nav-item has-submenu">
                ...
                <div id="submenu-7" class="collapse submenu submenu-7" data-bs-parent="#menu-accordion">
                    <ul class="submenu-list list-unstyled">
                        <li class="submenu-item"><a class="submenu-link" href="../Inventario/prestamos1.php">Realizar préstamo</a></li>
                        <li class="submenu-item"><a class="submenu-link" href="../Inventario/finalizarPrestamo.php">Finalizar préstamo</a></li>
                    </ul>
                </div>
            </li>
